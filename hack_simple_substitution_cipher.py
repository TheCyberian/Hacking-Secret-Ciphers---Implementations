import os, re, copy, pprint, simple_substitution_cipher, make_word_patterns


if not os.path.exists('wordPatterns.py'):
    make_word_patterns.main() # create the wordPatterns.py file
...
# Get a new cipherletter mapping for each ciphertext word.
        ...
        wordPattern = make_word_patterns.getWordPattern(cipherword)
